...
plot_temp_3day <- ggplot2::ggplot()+
  ...
  ggplot2::geom_point(data = firsttemp_3day, aes(x = date2, y = 12, color = station), size = 5, shape = 18) + facet_wrap(~fWY, strip.position = "left", nrow = 13)+
